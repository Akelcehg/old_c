...
class MonthDayConsumpProgressbarWidjet extends Widget
{
    ...
    public function run()
    {
        ...
        $prevDayC=CounterComponent::AllCountersMonthConsumption($this->user_type);
        ...
        echo IfaceHelper::ProgressBar(Yii::t('counterWidgets','ConsumpMonth'),$prevDayC,$prevDayC2.Yii::t('common','m3'),$percentage,'bg-color-blueLight');
    }
