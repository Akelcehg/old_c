...
<div style="width:60%;padding-left: 20px;">
    ...
    <div class="row">
        <div class="clear"></div>
        <?php echo $form->field($counter, 'user_id')->dropDownList(['Выберите пользователя'] + ArrayHelper::map(User::find()->all(), 'id', 'fullname'), ['id' => 'select2']) ?>
        <div class="errorMessage <?php echo get_class($counter) ?>_password_em_" style="display: none;"></div>
        <div class="clear"></div>
    </div>
    ...
    <div class="row">
        <div class="clear"></div>
        <?php echo $form->field($counter, 'user_type')->dropDownList($counter->getUserTypeList())->label('Тип пользователя') ?>
        <div class="errorMessage <?php echo get_class($counter) ?>_password_em_" style="display: none;"></div>
        <div class="clear"></div>
    </div>
