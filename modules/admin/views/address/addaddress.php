...
<?php echo $this->render('/layouts/partials/h1',array('title'=>Yii::t('address','AddingAddress'),'icon'=>'user'));
   echo $this->render('/layouts/partials/jarviswidget', array(
        ...
        'header' =>
            $this->render('/layouts/partials/jarviswidget/title', array(
                'title' => Yii::t('address','AddingAddress')
            ), true),
        'control' => $this->render('/layouts/partials/jarviswidget/control',[],true),
        'content' =>$this->render('_addAddress',['address'=>$address] , true)
    ));
    ?>
