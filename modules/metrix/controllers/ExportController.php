...
class ExportController extends Controller
{
    ...
    public function actionAjaxlistcounterbyfile()
    {
        ...
        $counter = MetrixCounter::find()->all();
    ...
    protected function CountersToExcel($counters,$columns,$fileFormat){
        ...
        $titles=[];
        $counterModel = new MetrixCounter();
    ...
    {
        $geo_location_id=Yii::$app->request->get('geo_location_id',null);
        $counter = MetrixCounter::find()->filterWhere(['geo_location_id'=>$geo_location_id])->all();
