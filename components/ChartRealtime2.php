...
class ChartRealtime2 extends Widget {

    public $name = 'MyCorrChart';
    public $type = 'Line';
    public $typeCorr='prom';
    public $width = 1059;
    public $height = 400;
    public $labels = [];
    ...
    public function init() {
        ...
        $this->getView()->registerJsFile(Yii::$app->request->baseUrl . '/js/chart/Chart_yiir_oneCorrector.js');
    ...
    public function config() {
        ...
        $string.="var typeCorr = '" . $this->typeCorr . "';";
