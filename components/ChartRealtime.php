...
class ChartRealtime extends Widget {
    ...
    public function init() {
        ...
        $this->getView()->registerJsFile(Yii::$app->request->baseUrl . '/js/chart/Chart_yiir.js');

        echo '<header><h2 id="label'. $this->name .'"></h2></header>';

        echo RtSwitchWidget::widget();

        echo '<canvas id="' . $this->name . '" style="height:'.$this->height.';width:100%;" class="chartCanvas" ></canvas>';
    }
