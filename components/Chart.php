...
class Chart extends Widget {
    ...
    $this->getView()->registerJsFile(Yii::$app->request->baseUrl . '/js/chart/Chart_yii.js');}
    ...
    if( $this->type1=='dayChart'){
        ...
        . '<span style="float:right;width:200px">&nbsp;<span style="cursor: pointer;font-size:20px;" id="consumtionSumm"> Расход:</span></span>'
        . '</div>';
    }
