...
class ChartTwo extends Widget
{
    ...
    public function init()
    {
        ...
        echo '<div class="dateControl"  style="clear:both;text-align:center;">'
            ...
            . '<span style="width:85px;margin-left:20px"><span id="now" style="display:none;font-size:20px; font-weight:bolder;">Сегодня</span></span>'
            ...
            . '</span>'
            . '</div>';
        echo Html::tag('h6',Yii::t('prom','temperature'));
        ...
        $this->getView()->registerJsFile(Yii::$app->request->baseUrl . '/js/chart/Chart_yii_ajax.js', ['position' => 2]);
