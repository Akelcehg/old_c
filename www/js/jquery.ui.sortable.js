...
(function($) {
	...
	$.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		_mouseStop: function(event, noPropagation) {
			...
			setTimeout('$("#'+this.element.attr("id")+'").trigger("change");', 500);
		...
		toArray: function(o) {
			...
			function _recursiveArray(item, depth, left) {
				...
				if (id) {
						ret.push({"item_id": id[2], "id": $(item).attr("id"), "parent_id": pid, "depth": depth, "left": left, "right": right});
				}
