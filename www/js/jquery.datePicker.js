		...
		renderCalendar  :   function(s)
		{
			...
			while (w++<weeksToDraw) {
				...
				for (var i=0; i<7; i++) {
					...
					/* Jordan changes - Add classes to know the date */
					var year_formated = currentDate.getFullYear();
					
					var month_formated = currentDate.getMonth();
					month_formated += 1;
					if(month_formated < 10){
						month_formated = "0"+month_formated;
					}
					
					var day_formated = currentDate.getDate();
					if(day_formated < 10){
						day_formated = "0"+day_formated;
					}
					d.addClass(year_formated+"-"+month_formated+"-"+day_formated);
