...
$(function () {
    ...
    var ctx = document.getElementById(nameBar).getContext("2d");
    ...
    var myLineChart = new Chart(ctx).Bar(data,eval('option'+nameBar));
   ...
   $(window).resize(function() {canvasResize()});
    ...
    function counterToChart(e) {
        ...
        $.get(app.baseUrl + '/prom/correctors/ajaxcountertochart', {
            counter_id: get['id'],
            beginDate: beginData,
            endDate: endData,
            type:get['type']
