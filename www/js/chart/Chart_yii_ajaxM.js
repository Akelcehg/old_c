$(function () {
    ...
    function WeekChartAndConsumption(counter_id)
    {
     ...
     function counterToConsumptionDetailByWeek(counter_id,data) {
        ...
        $.post(app.baseUrl + '/metrix/operations/ajaxcountertoconsumtiondetailbyweek', {
  ...
  /*  function counterToConsumptionDetailByDay(counter_id) {
    ...
    function counterToChartByWeek(counter_id, data) {
        ...
        get = parseGetParams();
        $.post(app.baseUrl + '/metrix/operations/ajaxcountertochartbyweek', {
            counter_id: counter_id,
            data:data,
            lang:get['lang']
        }, function (json) {
    ...
    function counterToChartByDay(counter_id) {
        ...
        $.get(app.baseUrl + '/metrix/operations/ajaxcountertochartbyday', {
            counter_id: counter_id,
            beginDate: beginData,
            endDate: endData,
            type: get['type'],
    ...
    function counterToTempChartByMonth(counter_id) {
        ...
        $.get(app.baseUrl + '/metrix/operations/ajaxcountertochart', {
            counter_id: counter_id,
            beginDate: beginData,
            endDate: endData,
            type: get['type'],
