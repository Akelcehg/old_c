...
$(function () {
    ...
    $(document.body).on('click', '#onoffswitch',function(){rtChartSwitch(); generateData();});
    $(document.body).on('click', '#onoffswitch-label',function(){rtChartSwitch(); generateData();});
    $(document.body).on('click', '#onoffswitch-switch',function(){rtChartSwitch(); generateData();});
    ...
    setTimeout(function(){killGenerateDate()}, 3600000);

    function generateDataAjaxQuery(){
        rtCheck()
        get=parseGetParams()
        $.get(app.baseUrl + '/prom/rtchart/ajaxcheck', {type:get['type'],   lang:get['lang']}, function (json) {
    ...
    function rtCheck() {
        get=parseGetParams()
            ...
            $.get(app.baseUrl + '/prom/rtchart/rtview', {
                    lang:get['lang']
            },

                function (htmlData) {
                    $('#RtSwitch').replaceWith(htmlData)
                })

    }


    function rtChartSwitch() {
        get=parseGetParams()

        $.get(app.baseUrl + '/prom/rtchart/rtswitch', {
                lang:get['lang']
        },
